...
const normalizeAngle = (d: any) => ((d % 360) + 360) % 360;
const wrapAngleSigned = (deg: any) => {
    const a = (((deg + 180) % 360) + 360) % 360;
    return a - 180;
};
const getDataNumber = (el: any, name: any, fallback: any) => {
...
function computeItemBaseRotation(offsetX: any, offsetY: any, sizeX: any, sizeY: any, segments: any) {
...
export default function DomeGallery({
    ...
    const applyTransform = (xDeg: any, yDeg: any) => {
    ...
    useEffect(() => {
        ...
        const close = () => {
            ...
            overlay.remove();
            (rootRef.current as HTMLElement).appendChild(animatingOverlay);
    ...
    const openItemFromElement = useCallback(
        (el: any) => {
            ...
            (viewerRef.current as HTMLElement).appendChild(overlay);
